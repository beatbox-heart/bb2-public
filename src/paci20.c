...
IONIC_FTAB_HEAD(paci20) {
  #include "paci20_ftab.h"
...
IONIC_FDDT_HEAD(paci20,NV,NTAB,NO,NN) {
...
int create_paci20rhs (Par *par, Var *var, char *w, real **u, int v0)
{
  /* printf("xxxxxxxxxxxxxxxx create_paci20rhs entered\n"); */
  STR *S = (STR *)Calloc(1,sizeof(STR));
  char *ptr=w;
  int ivar=0;
  if (!S) ABORT("cannot create %s","paci20rhs");

...
/*=============================================*/
  ...
  if (conservative) {
    ...
    if (G(0,x+1,y)) W(p0) += MEAN( D(11) , DNB(11,x+1,y) );
    if (G(0,x-1,y)) W(m0) += MEAN( D(11) , DNB(11,x-1,y) );
    if (G(0,x,y+1)) W(0p) += MEAN( D(22) , DNB(22,x,y+1) );
    if (G(0,x,y-1)) W(0m) += MEAN( D(22) , DNB(22,x,y-1) );
  } else {
  ...
  if (conservative) {
    ...
    if (G(0,x,y+1)) W(0p) += MEAN( D(22) , DNB(22,x,y+1) );
    if (G(0,x,y-1)) W(0m) += MEAN( D(22) , DNB(22,x,y-1) );
    if (G(0,x+1,y+1)) W(pp) += half*MEAN( D(12) , DNB(12,x+1,y+1) );
    if (G(0,x-1,y+1)) W(mp) -= half*MEAN( D(12) , DNB(12,x-1,y+1) );
    if (G(0,x+1,y-1)) W(pm) -= half*MEAN( D(12) , DNB(12,x+1,y-1) );
    if (G(0,x-1,y-1)) W(mm) += half*MEAN( D(12) , DNB(12,x-1,y-1) );
  } else {
